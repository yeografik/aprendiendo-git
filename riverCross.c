...
int Lose(SIDE farmer, SIDE fox, SIDE chicken, SIDE corn){
	...
	if ((chicken == corn) && (fox == chicken) && (farmer != chicken)){ //Fox, chicken and corn alone...
		printf("Are you crazy?! you left everything behind! You lose...\n\n");
		return 1;
	}else if ((fox == chicken) && (farmer != fox)){ //Fox alone with the chicken...
